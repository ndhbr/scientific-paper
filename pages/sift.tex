...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=15.3cm]{sift-1}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=15.3cm]{sift-2}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}{.5\textwidth}
          \centering
          \includegraphics[width=.8\linewidth]{sift-3}
          \caption{Extrahierte Schlüsselpunkte}
          \label{fig:sift3}
        \end{subfigure}%
        \begin{subfigure}{.5\textwidth}
          \centering
          \includegraphics[width=.8\linewidth]{sift-5}
